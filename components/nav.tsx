  ...
  return (
    <nav className="flex items-center justify-between px-8">
      <div className="flex flex-row items-center p-4">
        ...
        <Link className="px-6 text-center text-[14.5px] text-[#B6979C]" href="/dashboard">
          Dashboard
        </Link>
        <Link className="px-6 text-center text-[14.5px] text-[#B6979C]" href="/lend">
          Lend
        </Link>
        <Link className="px-6 text-center text-[14.5px] text-[#B6979C]" href="/borrow">
          Borrow
        </Link>
        <a
