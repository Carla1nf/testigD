...
const Stat = ({
  ...
  return (
    <>
      ...
      <div
        key={title}
        className="overflow-hidden dashboard-item-gradient py-2 px-4 rounded-lg  flex-row justify-center items-center border border-white/5 h-full hidden md:flex"
      >
